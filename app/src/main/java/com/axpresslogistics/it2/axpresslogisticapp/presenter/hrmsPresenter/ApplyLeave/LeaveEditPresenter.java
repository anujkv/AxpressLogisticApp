...
public class LeaveEditPresenter implements MainInteractor {
    private Map<String, String> header;
    private Map<String, String> body;
    private Gson gson;

    public LeaveEditPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.editLeave(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<EditLeaveResponse>() {
                    @Override
                    public void call(EditLeaveResponse response) {
                        if (response != null) {
