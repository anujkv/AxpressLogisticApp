...
public class HRApprovalPresenter implements MainInteractor {
    Map<String, String> header;
    Map<String, String> body;
    Gson gson;

    public HRApprovalPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.hrApprovalRequest(header,body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<HRApprovalResponse>() {
                    @Override
                    public void call(HRApprovalResponse hrApprovalResponse) {
                        if(hrApprovalResponse !=null){
                            loadListener.onSuccess(hrApprovalResponse);
