...
public class VendorListPresenter implements MainInteractor {
    private Map<String,String> body ;
    private Map<String,String> header ;
    private Gson gson;

    public VendorListPresenter(Map<String, String> header, Map<String, String> body ) {
        this.body = body;
        this.header = header;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.vendorLisResponse(header,body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<VendorViewListResponse>() {
                    @Override
                    public void call(VendorViewListResponse response) {
                        if (response != null) {
