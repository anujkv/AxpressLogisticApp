...
public class AddVehicleReqPresenter implements MainInteractor {
    private Map<String, String> body ;
    private Map<String, String> header ;
    private Gson gson;

    public AddVehicleReqPresenter(Map<String, String> body, Map<String, String> header) {
        this.body = body;
        this.header = header;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.addVehicleReq(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<AddVehicleResponse>()
                {
                    @Override
                    public void call(AddVehicleResponse responseBody) {
