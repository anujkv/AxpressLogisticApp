...
public class VehicleApprovedListPresenter implements MainInteractor {
    private Map<String, String> body;
    private Map<String, String> header;
    private Gson gson;

    public VehicleApprovedListPresenter(Map<String, String> header, Map<String, String> body) {
        this.body = body;
        this.header = header;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.approvedVehicalList(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<VehicleApprovedListResponse>() {
                    @Override
                    public void call(VehicleApprovedListResponse response) {
                        if (response != null) {
                            Log.e("ResponseApproved",new Gson().toJson(response));
