...
public class NewVisitFormPresenter   implements MainInteractor {
    private Map<String, String> header;
    private Map<String, String> body;
    private Gson gson;


    public NewVisitFormPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.newVisitFormReq(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<NewVisitFormResponse>() {
                    @Override
                    public void call(NewVisitFormResponse response) {
                        if (response != null) {
