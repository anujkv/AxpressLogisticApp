...
public class VehicleApprovalListPresenter implements MainInteractor {

    private Map<String, String> body;
    private Map<String, String> header;
    private Gson gson;

    public VehicleApprovalListPresenter(Map<String, String> header, Map<String, String> body) {
        this.body = body;
        this.header = header;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.vehicleApprovalList(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<VehicleApprovalListResponse>() {
                    @Override
                    public void call(VehicleApprovalListResponse response) {
                        if (response != null) {
                            Log.e("RESPONSEApproval",new Gson().toJson(response));
