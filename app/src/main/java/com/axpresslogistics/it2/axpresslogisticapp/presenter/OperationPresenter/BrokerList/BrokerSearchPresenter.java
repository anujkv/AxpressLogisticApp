...
public class BrokerSearchPresenter implements MainInteractor {

    private Map<String, String> header;
    private Map<String, String> body;
    private Gson gson;

    public BrokerSearchPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.brokerSearchList(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<BrokerSearchResponse>() {
                    @Override
                    public void call(BrokerSearchResponse brokerSearchResponse) {
                        if (brokerSearchResponse != null) {

                            //   ProjectUtil.customToast(context, "response.getStatus()");
                            Log.e("Response",brokerSearchResponse.getStatus());
                            loadListener.onSuccess(brokerSearchResponse);
                        }
                        else {
