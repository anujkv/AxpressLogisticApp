...
class DocketPresenter implements MainInteractor {
    private Map<String, String> header;
    private Map<String, String> body;
    private Gson gson;

    public DocketPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.docketRequest(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<DocketResponse>() {
                    @Override
                    public void call(DocketResponse response) {
                        if (response != null) {
