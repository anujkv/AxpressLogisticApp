...
class LoginPresenter implements MainInteractor {
    ...
    public LoginPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.loginRequest(header,body)
