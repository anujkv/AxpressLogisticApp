...
public class SearchVisitFormListPresenter implements MainInteractor {
    ...
    public SearchVisitFormListPresenter(Map<String, String> header, Map<String, String> body) {
        this.header = header;
        this.body = body;
    ...
    public void loadItems(final LoadListener<Object> loadListener) {
        ...
        posApiInterface.visitformListSearch(header, body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io())
                .subscribe(new Action1<SearchVisitFormResponse>() {
                    @Override
                    public void call(SearchVisitFormResponse response) {
                        if (response != null) {
