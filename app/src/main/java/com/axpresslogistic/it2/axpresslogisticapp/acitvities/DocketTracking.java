...
import com.axpresslogistic.it2.axpresslogisticapp.adaptor.DocketTrackingAdaptor;
...
public class DocketTracking extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<com.axpresslogistic.it2.axpresslogisticapp.model.DocketTracking> challanList;
    String jsonString;
    JSONObject jObj;
    Intent intent;
    ...
    private void declareVariable() {
        ...
        challanList = new ArrayList<com.axpresslogistic.it2.axpresslogisticapp.model.DocketTracking>();
    }
        ...
        try {
            ...
            for (int i = 0; i < no_of_challan; i++) {
                ...
                if (i == 0) {
                    ...
                    com.axpresslogistic.it2.axpresslogisticapp.model.DocketTracking docketTracking = new
                            com.axpresslogistic.it2.axpresslogisticapp.model.DocketTracking(
